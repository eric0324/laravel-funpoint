 ...
 *  A一般開立
 */
class FunPoint_INVOICE  implements FunPointService
{
    // 所需參數
    ...
    public function checkExtendString(array $arParameters): array
    {
        ...
        if($arParameters['OnLine'] === false) {
            if( ($arParameters['CarruerType'] == FunPointCarruerType::None ) && strlen($arParameters['CustomerIdentifier']) == 0 ) {
                if ($arParameters['Print'] != FunPointPrintMark::Yes) {
        ...
        if ( ( $arParameters['TaxType'] != EcpayTaxType::Dutiable ) && ( $arParameters['TaxType'] != FunPointTaxType::Zero ) && ( $arParameters['TaxType'] != FunPointTaxType::Free ) && ( $arParameters['TaxType'] != FunPointTaxType::Mix ) ) {
        ...
        if(!empty($arParameters['vat'])) {
            if( ( $arParameters['vat'] != FunPointVatType::Yes ) && ( $arParameters['vat'] != FunPointVatType::No ) ) {
